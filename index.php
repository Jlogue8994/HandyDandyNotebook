            ...
            echo "<table align='center'>";
                ...
                echo "<tr>";
                    echo "<td>";
                        ...
                        echo "<div align='right'>";
                            echo "<input type='radio' name='period' value='1'>Beginning<br>";
                            echo "<input type='radio' name='period' value='2'>Middle<br>";
                            echo "<input type='radio' name='period' value='3'>End<br>";
                        echo "</div>";
                    echo "</td>";
                echo "</tr>";
                echo "<tr>";
                ...
                echo "<tr>";
                    echo "<td>";
                        ...
                        echo "<div align='right'>";
                            echo "<input type='radio' name='grouping' value='1'>Whole Group<br>";
                            echo "<input type='radio' name='grouping' value='2'>Small Group<br>";
                            echo "<input type='radio' name='grouping' value='3'>Individual<br>";
                            echo "<input type='radio' name='grouping' value='4'>Multiple Groupings<br>";
                        echo "</div>";
                    echo "</td>";
                echo "</tr>";
                echo "<tr>";
                ...
                echo "<tr>";
                    echo "<td>";
                        ...
                        echo "<div align='right'>";
                            echo "<input type='radio' name='differentiation' value='1'>Same Task/Same Level<br>";
                            echo "<input type='radio' name='differentiation' value='2'>Same Task/Different Level<br>";
                            echo "<input type='radio' name='differentiation' value='3'>Different Task/Same Level<br>";
                            echo "<input type='radio' name='differentiation' value='4'>Different Task/Different Level<br>";
                            echo "<input type='radio' name='differentiation' value='5'>No Evidence/No Activity<br>";
                        echo "</div>";
                    echo "</td>";
                echo "</tr>";
                echo "<tr>";
